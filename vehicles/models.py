...
class VehicleYear(OwnedModelMixin):
    ...
    odometer_start      = models.DecimalField(max_digits=10, decimal_places=1, validators=[MinValueValidator(0)], help_text="Odometer reading on Jan 1 (or start of year).",)
    odometer_end        = models.DecimalField(max_digits=10, decimal_places=1, validators=[MinValueValidator(0)], null=True, blank=True, help_text="Odometer reading on Dec 31 (or end of year).",)
