...
class Invoice(BusinessOwnedModelMixin):
    ...
    team                = models.ForeignKey(Team, on_delete=models.PROTECT, related_name="invoices", null=True, blank=True)
    ...
    def clean(self):
        ...
        if self.team_id and self.business_id and getattr(self.team, "business_id", None) != self.business_id:
